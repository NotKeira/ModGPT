...
#     embed = discord.Embed(title="Choose Your Gender", description="React with the corresponding emoji to choose your "
#                                                                   "gender role.")
#     embed.add_field(name="👨🏻", value="Male", inline=False)
#     embed.add_field(name="👩🏻", value="Female", inline=False)
#     embed.add_field(name="🧑🏻", value="If you are non-binary, please contact a staff member.", inline=False)
#
